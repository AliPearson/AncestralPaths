...
${path_to_relate}/scripts/RelateParallel/RelateParallel.sh -m 1.25e-8 --threads 8 -N 30000 --sample_ages ${output}.ages --haps ${output}_${i}.haps --sample ${output}_${i}.sample --map example/genetic_map_simulated.txt -o ${output}_relate_${i} --annot ${output}_${i}.annot
